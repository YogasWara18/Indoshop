...
export default function Banner() {
  return (
    <div className="px-[5%] md:px-[8%] lg:px-[12%] py-6 md:py-2">
      <div className="relative w-full h-[250px] sm:h-[350px] md:h-[400px] lg:h-[400px] overflow-hidden rounded-3xl">
        <div className="relative w-full h-full group">
          <Image
            src={deliveryMan}
            alt="Delivery Man"
            className="w-full h-full object-contain brightness-105 contrast-120 rounded-2xl"
            priority
          />
